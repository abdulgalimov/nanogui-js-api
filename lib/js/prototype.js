...
NanoguiModule.postRun.push(function() {
  ...
  Nanogui.Button.prototype._setCallbacks = function() {
    if (!this.id) {
      ...
      //
      if (!Nanogui.Button.byId) {
        Nanogui.Button.byId = {};
      }
      Nanogui.Button.byId[id] = this;
    }
  };
  ...
  Nanogui.Button.prototype.addChange = function(func) {
    this._setCallbacks();
  ...
  Nanogui.eventCallback = function nanoguiEvent(event) {
    var id = arguments[1];
    var button = Nanogui.Button.byId[id];
    if (!button) return;
    //
    var listeners;
    switch (event) {
      case 1:
        listeners = button._clickListeners;
        for (var i=0; i<listeners.length; i++) {
          listeners[i].func(button);
        }
        break;
      case 2:
        listeners = button._changeListeners;
        for (i=0; i<listeners.length; i++) {
          listeners[i].func(button, arguments[2]);
        }
        break;
    }
  };
